...
import { createProfesional, updateProfesional, deleteProfesional } from "@/actions/listados";

export default function ProfesionalesAdmin({ initialData }: { initialData: any[] }) {
  ...
  async function handleCreate() {
    ...
    setLoading(true);
    const res = await createProfesional(newNombre);
  ...
  async function handleUpdate(id: number) {
    setLoading(true);
    const res = await updateProfesional(id, editNombre, editActivo);
    if (res.error) { setError(res.error); }
    else {
  ...
  async function handleDelete(id: number, nombre: string) {
    ...
    const res = await deleteProfesional(id);
    if (res.error) { setError(res.error); }
